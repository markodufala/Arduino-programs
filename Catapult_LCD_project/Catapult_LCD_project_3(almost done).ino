...
int g =  150;
  ...
  // zniceny hrad
  byte riphrad1[8]    = {B00000,B00000,B00000,B00000,B00000,B00000,B00000,B00000};
  byte riphrad2[8]    = {B00001,B00001,B00011,B00111,B00101,B00111,B00101,B00011};
  byte riphrad3[8]    = {B00000,B00000,B00000,B00000,B00000,B00000,B00001,B00011};
  byte riphrad4[8]    = {B00011,B00010,B00100,B00100,B01100,B11100,B11100,B11100};
  byte riphrad5[8]    = {B10000,B10000,B11000,B11101,B11111,B11111,B10101,B11111};
  byte riphrad6[8]    = {B00000,B00000,B00000,B00000,B11010,B11111,B01011,B11111};
  byte riphrad7[8]    = {B11111,B01111,B00111,B00111,B00111,B00111,B00111,B00111};
  byte riphrad8[8]    = {B11111,B11111,B11111,B11011,B10001,B11011,B11111,B11111};
...
void otazka() { 
  ...
  lcd.clear();
//zniceny hrad
  lcd.createChar(8,  riphrad1);
  lcd.createChar(9,  riphrad2);
  lcd.createChar(10,  riphrad3);
  lcd.createChar(11,  riphrad4);
  lcd.createChar(12,  riphrad5);
  lcd.createChar(13,  riphrad6);
  lcd.createChar(14,  riphrad7);
  lcd.createChar(15,  riphrad8);
  lcd.setCursor(12,0);
  lcd.write(8);
  lcd.setCursor(13,0);
  lcd.write(9);
