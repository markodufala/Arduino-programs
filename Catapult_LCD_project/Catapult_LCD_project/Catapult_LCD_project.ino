...
int q =  400;
  ...
  //   hrad 1/1
  byte hrad20[8]    = {B00000,B00000,B00000,B00101,B00111,B00111,B00110,B10111};
  byte hrad21[8]    = {B00100,B01110,B01110,B01010,B11111,B11111,B10101,B11111};
  byte hrad22[8]    = {B00000,B00000,B00000,B10100,B11100,B11100,B01100,B11101};
  byte hrad23[8]    = {B11111,B11111,B11111,B11111,B11111,B11111,B11111,B11111};
  byte hrad24[8]    = {B11111,B11011,B10001,B10001,B10001,B10001,B10001,B10001};
  byte hrad25[8]    = {B11111,B11111,B11111,B11111,B11111,B11111,B11111,B11111};
...
void domcek(){
  ...
  lcd.createChar(10, hrad20);
  lcd.createChar(11, hrad21);  
  lcd.createChar(12, hrad22);
  lcd.createChar(13, hrad23);
  lcd.createChar(14, hrad24);
  lcd.createChar(15, hrad25);
  lcd.setCursor(13,0);
  lcd.write(10);
  lcd.setCursor(14,0);
  lcd.write(11);
